...
def print_sobol_results(Si, problem):
    ...
    print(f"  The Oswald efficiency factor 'e' is an empirical correlation")
    print(f"  with wide scatter across aircraft types. For a novel hydrogen")
    print(f"  aircraft, no validated data exists — this is structural model")
    print(f"  uncertainty, not a tuneable parameter. Shrinking uncertainty")
    print(f"  in 'e' is the fastest path to reducing range uncertainty.")
    print("=" * 65)
